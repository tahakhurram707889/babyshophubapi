                        ...
                        <select class="form-select" id="category_id" name="category_id" required>
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" 
                                    {{ $product->category_id == $category->id ? 'selected' : (old('category_id') == $category->id ? 'selected' : '') }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                        ...
                        @if($product->image)
                            <div class="mb-3">
                                <img src="{{ asset('storage/' . $product->image) }}" alt="Current Image" 
                                     class="img-fluid rounded mb-2 border" style="max-height: 200px;">
                    ...
                    <div class="card mt-3">
                        <div class="card-body bg-light">
                            ...
                            <p class="mb-1"><strong>Created:</strong> {{ $product->created_at->format('M d, Y H:i') }}</p>
                            <p class="mb-0"><strong>Last Updated:</strong> {{ $product->updated_at->format('M d, Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
